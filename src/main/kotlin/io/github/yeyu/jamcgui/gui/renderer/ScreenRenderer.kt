package io.github.yeyu.jamcgui.gui.renderer

import com.mojang.blaze3d.systems.RenderSystem
import io.github.yeyu.jamcgui.gui.handler.ClientScreenHandler
...
import io.github.yeyu.jamcgui.gui.renderer.widget.Widget
import io.github.yeyu.jamcgui.gui.renderer.widget.listener.KeyListener
import io.github.yeyu.jamcgui.gui.renderer.widget.listener.Listener
...
open class ScreenRenderer<T : ScreenRendererHandler>(
    ...
    @Deprecated(
        ...
        ReplaceWith(
            ...
            "io.github.yeyu.jamcgui.gui.renderer.widget.ParentWidget",
            "io.github.yeyu.jamcgui.gui.renderer.widget.listener.Listener"
        )
    )
     ...
     * subclass
     *
     * @see io.github.yeyu.jamcgui.gui.renderer.widget.listener.MouseListener
     * @see io.github.yeyu.jamcgui.gui.renderer.widget.listener.KeyListener
     */
    ...
    @Deprecated(
        ...
        ReplaceWith("setFocused", "io.github.yeyu.jamcgui.gui.renderer.widget.Widget")
    )
    ...
    @Deprecated(
        "Delegate focus events on the widget itself!",
        ReplaceWith("onMouseDown", "io.github.yeyu.jamcgui.gui.renderer.widget.listener.Listener")
    )
    ...
    @Deprecated(
        "Delegate focus events on the widget itself!",
        ReplaceWith("render", "io.github.yeyu.jamcgui.gui.renderer.widget.ParentWidget")
    )
