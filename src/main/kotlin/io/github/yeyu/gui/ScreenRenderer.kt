...
import io.github.yeyu.gui.widget.Widget
import io.github.yeyu.gui.widget.listener.KeyListener
import io.github.yeyu.gui.widget.listener.Listener
...
abstract class ScreenRenderer<T : ScreenRendererHandler>(handler: T, inventory: PlayerInventory, title: Text?) :
    ...
    @Deprecated(
        ...
        ReplaceWith(
            ...
            "io.github.yeyu.gui.widget.listener.Listener"
        )
    )
     ...
     * subclass
     *
     * @see io.github.yeyu.gui.widget.listener.MouseListener
     * @see io.github.yeyu.gui.widget.listener.KeyListener
     */
